...
const schools_repository_1 = require("./schools.repository");
...
SchoolsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(schools_repository_1.SchoolsRepository)),
    __metadata("design:paramtypes", [schools_repository_1.SchoolsRepository])
], SchoolsService);
